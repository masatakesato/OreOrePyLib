...
if __name__=='__main__':
    ...
    mdiManager = TabbedMDIManager()

    tabFrame1_id = mdiManager.AddDockable( TabWidget, Duration.Persistent )
    tabFrame1 = mdiManager.GetDockable( tabFrame1_id )
    ...
    mdiManager.AddTab( tabFrame1_id, widget1, widget1.windowTitle(), id(widget1) )
